require "danger/ci_source/appcenter"

RSpec.describe Danger::Appcenter do
  let(:valid_env) do
    {
      "BITRISE_PULL_REQUEST" => "4",
      "APPCENTER_BUILD_ID" => "4",
      "BUILD_REPOSITORY_URI" => "https://github.com/artsy/eigen"
    }
  end
  ...
  describe "#new" do
    ...
    it "sets the repo_slug from a repo with dots in it", host: :github do
      valid_env["BUILD_REPOSITORY_URI"] = "git@github.com:artsy/artsy.github.io"
    ...
    it "sets the repo_slug from a repo with two slashes in it", host: :github do
      valid_env["BUILD_REPOSITORY_URI"] = "git@github.com:artsy/ios/artsy.github.io"
      expect(source.repo_slug).to eq("artsy/ios/artsy.github.io")
    end

    it "sets the repo_slug from a repo https url", host: :github do
      valid_env["BUILD_REPOSITORY_URI"] = "https://github.com/artsy/ios/artsy.github.io"
      expect(source.repo_slug).to eq("artsy/ios/artsy.github.io")
    end
